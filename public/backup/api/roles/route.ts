...
export async function GET() {
  try {
    ...
    console.log("Roles API - Session:", session?.user?.id ? "Authenticated" : "Not authenticated");
    
    if (!session?.user?.id) {
      console.log("Roles API - Unauthorized access attempt");
    ...
    // Temporarily skip permission check to debug
